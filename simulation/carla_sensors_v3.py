...
from simulation.simulation_settings_v3 import RGB_CAMERA
...
#
# Geometry/camera/IMU mount được lấy từ vehicle_specs_v3.py
...
# từ vehicle_specs_v3.py. Không khai báo lại ở đây.
#
# Giá trị hiện tại (nếu vehicle_specs_v3.py đã được cập nhật):
...
class IMUSensorV3:
    ...
    def __init__(self, vehicle):
        ...
        weak_self = weakref.ref(self)
        self.sensor.listen(
            lambda data: IMUSensorV3._on_imu(weak_self, data)
        )
