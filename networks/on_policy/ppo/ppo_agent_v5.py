# -*- coding: utf-8 -*-
"""
GĐ14.2 - Canonical PPOAgent V5 with correct terminal/truncation handling.
...
from networks.on_policy.ppo.actor_critic_v5 import ActorCritic
from observation_builder_rgb_v5 import OBSERVATION_DIM_V5
...
class PPOAgent(object):
    def __init__(
        ...
        self.obs_dim = OBSERVATION_DIM_V5
    ...
    def load(
        ...
        if not (
            ...
            raise RuntimeError(
                "Checkpoint cũ không tương thích PPO V5."
            )
        ...
        if checkpoint.get(
            ...
            raise RuntimeError(
                "Checkpoint không phải PPO V5 GĐ14."
            )
