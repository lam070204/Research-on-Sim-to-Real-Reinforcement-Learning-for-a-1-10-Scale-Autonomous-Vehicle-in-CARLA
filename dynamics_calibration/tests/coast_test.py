...
- last 101 samples of the 5 s pre-speed segment (~2 s inclusive),
  matching the REAL summary.
...
# Last 101 samples ~= 2.0 s inclusive at 50 Hz.
INITIAL_STEADY_SAMPLES = 101
...
def main():
    ...
    print("=" * 88)
    print("GĐ4 - TEST 3 DECELERATION / COAST")
    print("=" * 88)
