...
def main():
    ...
    print("=" * 88)
    print("GĐ4 - TEST 3 DECELERATION / COAST - SMALL MAP - TUNE V2")
    print("=" * 88)
    ...
    try:
        ...
        for initial_cmd, final_cmd in CASES:
            ...
            # Quan trọng với Tune V2 fixed manual gear:
            # cần commit lệnh manual_gear_shift=True, gear=1 vào CARLA
            # bằng một synchronous tick trước khi bắt đầu profile đo.
            # Test 2 V2 đã có tick này; Test 3 V2 bản trước bị thiếu nên
            # actor có thể vẫn ở gear=0 trong cả pre-speed segment.
            world.tick()

            control_after_reset = vehicle.get_control()
            print(
                "    GEAR READY | manual={} | gear={}".format(
