...
from encoder_init_rgb import EncodeStateRGB
...
class RGBDatasetPerSpawn:
    ...
    def _write_manifest(self):
        ...
        lines = [
            "RGB DATASET FROM continuous_driver_rgb.py",
            "",
            ...
            "PPO model namespace: mapden_rgb",
...
def collect_rgb_dataset_with_trained_ppo(
    ...
    print("\n===== RGB COLLECTION MODE =====")
    print("Driver       : continuous_driver_rgb.py")
    print("PPO          : mapden_rgb, inference only")
...
def runner():
    ...
    encode = EncodeStateRGB(LATENT_DIM)
