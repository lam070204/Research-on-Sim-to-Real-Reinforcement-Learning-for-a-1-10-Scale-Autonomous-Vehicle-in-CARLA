# -*- coding: utf-8 -*-
"""
Domain Randomization V5 SIMPLE - SAFE BASELINE
...
DOMAIN_RANDOMIZATION_RANGES = {
    ...
    # Lateral - calibrated
    "steer_gain_positive": (
        STEER_GAIN_POSITIVE_NOMINAL * 0.90,
        STEER_GAIN_POSITIVE_NOMINAL * 1.10,
    ),
    "steer_gain_negative": (
        STEER_GAIN_NEGATIVE_NOMINAL * 0.90,
        STEER_GAIN_NEGATIVE_NOMINAL * 1.10,
    ),
...
EXTRA_DELAY_ONE_TICK_PROBABILITY = 0.10
